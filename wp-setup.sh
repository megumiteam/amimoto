...
plugin_install "nginx-champuru.1.6.0.zip" "$SERVERNAME" > /dev/null 2>&1
...
plugin_install "nephila-clavata.0.2.1.zip" "$SERVERNAME" > /dev/null 2>&1
plugin_install "jetpack.2.3.5.zip" "$SERVERNAME" > /dev/null 2>&1
