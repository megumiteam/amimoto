...
plugin_install "wpbooster-cdn-client.2.4.1.zip" "$SERVERNAME" > /dev/null 2>&1
...
plugin_install "wp-total-hacks.1.1.1.zip" "$SERVERNAME" > /dev/null 2>&1
plugin_install "flamingo.1.0.3.zip" "$SERVERNAME" > /dev/null 2>&1
plugin_install "contact-form-7.3.3.3.zip" "$SERVERNAME" > /dev/null 2>&1
plugin_install "jetpack.2.1.1.zip" "$SERVERNAME" > /dev/null 2>&1
